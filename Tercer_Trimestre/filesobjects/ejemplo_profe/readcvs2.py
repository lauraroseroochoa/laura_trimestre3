...
#print(listaAprendices) #aprendices como objetos

for apr in listaAprendices:
    #print(apr)
    print('first name:',apr.getNombre())
    print('last name:',apr.getApellido())
    print('email:',apr.getCorreo())
    print('id:',apr.getDocumento())
